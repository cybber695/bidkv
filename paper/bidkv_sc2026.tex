...
\begin{subfigure}[b]{0.50\textwidth}
  ...
  \caption{Victim-selection trade-off space across 150 KV-pressure snapshots
    ...
    The \textbf{ideal zone} (gold shading) is upper-left: high KV freed at low
    recompute cost.
    LIFO\,(red) sits in the lower-left ($\bar{r}\!=\!0.21$, $\bar{c}\!=\!0.13$) — low KV recovery,
    wasting each preemption opportunity.
    PE-SJF\,(blue) uses SJF admission yet keeps LIFO victim selection; it clusters near LIFO
    ($\bar{r}\!=\!0.16$, $\bar{c}\!=\!0.07$), confirming that admission policy alone
    cannot fix victim selection.
    BidKV\,(yellow) breaks free: near-maximum KV recovery at moderate cost
    ($\bar{r}\!=\!0.98$, $\bar{c}\!=\!0.56$), dominating both alternatives.}
...
\caption{\textbf{The victim-selection problem under KV pressure.}
  ...
  Y\,=\,KV footprint rank.
  LIFO wastes KV capacity ($\bar{r}\!=\!0.21$); PE-SJF changes admission order yet
  its LIFO victim selection stays equally adrift ($\bar{r}\!=\!0.16$); BidKV occupies
  the ideal upper-left zone ($\bar{r}\!=\!0.98$, $\bar{c}\!=\!0.56$), dominating both baselines.}
