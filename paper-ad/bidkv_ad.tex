...
python -m bidkv.experiments.vllm.runner \\
    --strategies preempt-evict,preempt-evict-sjf,\\
                 static-random,largest-first,bidkv \\
...
python -m bidkv.experiments.sglang.analysis \\
    --results-dir results/sglang_portability/ \\
    --output-dir results/sglang_portability/analysis/
    \end{Verbatim}
